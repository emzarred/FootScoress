 ...
 */
public class AwayPlayedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public AwayPlayedFragment() { }


    // 2 - Method that will create a new instance of CompetitionFragment, and add data to its bundle.
    public static AwayPlayedFragment newInstance(int position, int color) {

        // 2.1 Create new fragment
        AwayPlayedFragment frag = new AwayPlayedFragment();
